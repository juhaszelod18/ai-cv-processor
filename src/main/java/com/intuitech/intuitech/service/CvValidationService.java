...
public class CvValidationService {
    ...
    private static final String PROFILE_VALIDATION_PROMPT = """
            ...
            Determine whether the profile expresses BOTH of the following aspirations (wording may vary):
            1. Interest in GenAI and a desire to become an expert in it.
            2. Interest in Java and a desire to become an expert in it.

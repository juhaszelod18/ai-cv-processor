...
public class CvExtractionService {
    ...
    private static final String EXTRACTION_PROMPT = """
            ...
            - languages: list all spoken/written languages mentioned. Include only the language name (e.g. "English", "Hungarian") — do not include proficiency levels or qualifiers.
